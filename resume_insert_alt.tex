...
\begin{itemize}
    \item   Led company technical development through implementation of most
        ...
        presentation of Google Trends Search data. The resulting \emph{pyunum}
        module contains Python interfaces to custom Google Trends data
...
\cvitemwithcomment{Programming/DevOps}{\texttt{Python (\& Jupyter)}, Azure,
\texttt{SQL, R}, Git, Unix Shell}{Expert}
