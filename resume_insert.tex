...
\cvitemwithcomment{Development}{\texttt{Python (\& Jupyter)}, Azure*,
\texttt{SQL, R}, Git, Unix Shell}{Expert, ~6+ years}
\cvitemwithcomment{Statistics}{\texttt{Numpy, Pandas}}{Expert, ~6+ years}
\cvitemwithcomment{BI/Visualization}{Microsoft Power BI, \texttt{DAX},
\texttt{Matplotlib}}{Expert, ~3 years}
...
these concepts or technologies (not limiting nor exhaustive)}}
